...
group_out_dir = 'assets/experimental_results/exp_13_synth_change_point_one_dim_hl3'
group_params_dir = 'assets/experimental_configurations/exp_13_synth_change_point_one_dim_hl3'
...
model_params_path = 'assets/experimental_configurations/exp_13_synth_change_point_one_dim_hl3/model_lin_reg.json'
try:
