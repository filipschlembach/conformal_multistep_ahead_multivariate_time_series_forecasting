...
group_out_dir = 'assets/experimental_results/exp_05_longelec2_rnn_wfct'
group_params_dir = 'assets/experimental_configurations/exp_05_longelec2_rnn_wfct'

# in this experiment I want to compare and calibrate different weight functions, different correction methods and
# the univariate to the multivariate setting.
...
model_params_path = 'assets/experimental_configurations/exp_05_longelec2_rnn_wfct/model_rnn.json'
