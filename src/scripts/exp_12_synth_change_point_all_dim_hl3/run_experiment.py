...
group_out_dir = 'assets/experimental_results/exp_12_synth_change_point_all_dim_hl3'
group_params_dir = 'assets/experimental_configurations/exp_12_synth_change_point_all_dim_hl3'
...
univariate_and_multivariate_ds = {
    'multv': 'ds_synth_change_point.json',
}

n_trials = 20

model_params_path = 'assets/experimental_configurations/exp_12_synth_change_point_all_dim_hl3/model_lin_reg.json'
try:
